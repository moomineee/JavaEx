...
public class MapExercise {
    public static void main(String[] args) {
        ...
        //TreeMap<String, String> map = new TreeMap<>(); HashMap 친구. 용도에 맞춰서 사용.
        //   key  , value
        ...
        map.put("노석현", "https://github.com/Screate/Likelion3th");
        ...
        map.put("백다은", "https://github.com/sangho527/Like_Lion_Java");
        ...
        // git 주소를 찾으려면 키워드인 이름부터 찾아야함. 주민등록번호도 가능.
        // list로 검색을 할 경우 속도가 느림. map을 쓰면 속도가 빠름.
        // 왜? 순차적으로 접근하지 않아도 키워드만 입력하면 검색 가능
        System.out.println(map.get("박기문"));
