...
public class names {
    ...
    public List<Student> getStudentObjs() {
        this.studentObjs.add(new Student(1, "권하준", "https://github.com/dongyeon-0822/java-project-exercisehttps://github.com/kang-subin/Java"));
        this.studentObjs.add(new Student(3, "안예은", "https://github.com/kang-subin/Java"));
        this.studentObjs.add(new Student(1, "남우빈", "https://github.com/KoKwanwun/LikeLion.git"));
        this.studentObjs.add(new Student(2, "최경민", "https://github.com/lcomment/Algorithm_Solution--Java/tree/main/LikeLion"));
        this.studentObjs.add(new Student(3, "안준휘", "https://github.com/cmkxak/likelion-java-course"));
        return studentObjs;
    }
