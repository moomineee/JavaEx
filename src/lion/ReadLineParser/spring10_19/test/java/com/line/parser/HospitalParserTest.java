...
class HospitalParserTest {
    ...
    void HospitalParsing() {
        ...
        assertHospital((hospitalParser.parse(this.line2)),
                "A1104130", "서울특별시 강남구 도산대로 118 (논현동 신사빌딩 2층)",
                    "서울특별시 강남구", "C", 2, "365엠씨의원", "");
...
//        Assertions.assertEquals(address, hospital.getAddress());// 이 상태에서는 null이 나옴.
